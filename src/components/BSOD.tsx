        ...
        <div className="relative z-10 flex flex-col items-center gap-6 md:gap-8">
            ...
            {clickCount < 5 ? (
                <div className="space-y-4 md:space-y-6 font-medium tracking-wide text-sm md:text-lg leading-relaxed select-none">
                   <p>
  The system has encountered an unexpected condition and entered a protective shutdown state.
</p>
...
<p className="text-gray-400">
  ...
  Classic fix detected: simulated reboot required.
</p>

                    <p className="text-gray-400 text-sm">
  (Click anywhere to dismiss this screen)
</p>
